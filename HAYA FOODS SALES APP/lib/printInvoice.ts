...
export function printInvoice(invoice: PrintableInvoice) {
  ...
  <style>
    * { box-sizing: border-box; } body { margin: 0; font-family: Arial, Helvetica, sans-serif; color: #17211e; background: #f4f7f6; }
    ...
    <section class="top"><div><h1 class="brand">Haya Foods</h1><p class="sub">Sales, Billing, Inventory &amp; Delivery</p></div><div><h2 class="invoice-title">TAX INVOICE</h2><div class="number">${escapeHtml(invoice.invoice_number)}</div></div></section>
